...
// Cek login dan role resepsionis
    ...
    <main class="ml-[300px] pr-8 pl-2 py-6">
        ...
        <div class="gradient-card rounded-2xl p-6 mb-6 text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h1 class="text-2xl font-bold mb-1">Jadwal Praktik Dokter</h1>
                <p class="text-blue-100">Lihat jadwal praktik dokter di RomCare Clinic</p>
            </div>
        </div>

        <!-- Filter Days Section -->
        <div class="glass-effect rounded-xl p-6 mb-6 flex items-center justify-between flex-wrap gap-4">
